...
Create a token that encrypts details of your customer, a game and purchase parameters.
...
||||
|---|---|---|
|`token` |string|A secure string which contains encrypted information about your customer and sales option data.  |
